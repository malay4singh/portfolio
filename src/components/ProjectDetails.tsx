...
function ProjectDetails(props: ProjectDetailsProps){
        ...
        return(
                <div className={`p-7 border-2 border-black absolute w-[75%] h-[17%] ${props.visibility ? "visible" : "invisible"} bg-[#156064] text-[#FFFFF0] rounded-lg max-[600px]:w-[16%] max-[600px]:h-fit max-[600px]:overflow-y-scroll`}>
