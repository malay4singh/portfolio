...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      features: [
        "Full-Stack project using React.js and Express.js",
    ...
    },
    {
      ...
      tech: ["JavaScript", "jQuery", "HTML", "CSS"],
      features: [
        "Custom text inputs as to-do items",
    ...
    },
    {
      ...
      features: [
        ...
        "CSS Styling tricks such as flexbox, sticky divs etc.",
      ],
    },
  ];
  ...
  return (
    <div className="h-screen w-[90vw] flex items-center justify-center max-[600px]:w-screen max-[600px]:h-[90dvh] max-[1200px]:items-start max-[600px]:py-10 scrollable relative">
      <div className="w-[80%] flex flex-col gap-6 z-0 b">
      ...
      <ProjectDetails
        setVisibility={setVisibility}
        visibility={visibility}
        projectDetails={projectDetaills}
      />
    </div>
  );
}
